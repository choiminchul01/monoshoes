...
export default function PartnerPage() {
    ...
    useEffect(() => {
        ...
        const partnerRandomDelays = PARTNER.map(() => Math.random() * 1.2 + 0.8); // Start slightly after ESSENTIA

        setEssentiaDelays(essentiaRandomDelays);
        setPartnerDelays(partnerRandomDelays);

        // Find which letter lands last for each word (max delay)
        ...
        // Find max delay across both words
    ...
    const letterAnimation = (delay: number, isGold: boolean = false) => ({
        ...
        transition: {
            ...
            opacity: { duration: 1.5, delay: delay, ease: "easeOut" },
